                    ...
                    <div className="card-body">
                        ...
                        <form>
                            <fieldset className="fieldset">
                                ...
                                <button className="btn btn-outline px-7 hover:bg-linear-to-r from-[#632EE3] to-[#9F62F2] border-[#632EE3] font-semibold text-[#632EE3] hover:text-white transition-all text-base"> <FaGoogle size={20}></FaGoogle> Login with Google</button>
                            </fieldset>
                        </form>
                    </div>
                </div>
